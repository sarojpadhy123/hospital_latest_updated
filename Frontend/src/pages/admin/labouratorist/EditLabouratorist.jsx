...
function EditLabouratorist() {
  ...
  const UpdateStaff = (e) => {
    ...
    axios
      ...
      .then((res) => {
        navigate("/admin/labouratorists", { replace: true }),
  ...
  return (
    <AdminSidebar>
      <FormLayout formName="EDIT LABOURATORIST">
        <form onSubmit={UpdateStaff}>
          ...
          <Button>
            {loading ? <ButtonPreloader /> : "EDIT LABOURATORIST"}
          </Button>
        </form>
      </FormLayout>
    </AdminSidebar>
...
export default EditLabouratorist;
